...
\item $x \cdot y = 0 \Longleftrightarrow x = 0 \vee y = 0$
...
\item $x < y \Longleftrightarrow -y < -x$
...
\enum {
\item $x < 0 \overset{Def.}{\Longleftrightarrow} 0 > x \overset{Def.}{\Longleftrightarrow} 0-x > 0$
...
\section{Satz}
\enum {
	\item $\left\vert x\right\vert ≥ 0$ wobei $\left\vert x\right\vert \Longleftrightarrow x = 0$
	\item $\left\vert x \cdot y\right\vert = \left\vert x\right\vert \cdot \left\vert y\right\vert$
	\item $\left\vert\frac{x}{y}\right\vert = \frac{\left\vert x\right\vert}{\left\vert y\right\vert}$ falls $y \neq 0$
	\item $\left\vert x + y\right\vert ≤ \left\vert x\right\vert + \left\vert y\right\vert$ (Dreiecksungleichung)
}
\subsection*{Beweise}
\enum {
	\item klar.
